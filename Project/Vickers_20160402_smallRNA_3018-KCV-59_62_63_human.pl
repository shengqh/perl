...
my $def = {
	...
	files => {
		...
		"1146_hem_Baseline"              => ['/gpfs21/scratch/cqs/zhaos/vickers/data/3018/3018-KCV-62/3018-KCV-62-i11_S11_R1_001.fastq.gz'],
		...
		"1146_hem_Baseline"              => ['/gpfs21/scratch/cqs/zhaos/vickers/data/3018/3018-KCV-63/3018-KCV-63-i11_S10_R1_001.fastq.gz'],
	...
	groups => {
		...
		"Hem_Baseline"   => [
			"1097_hem_Baseline", "1114_hem_Baseline", "1077_hem_Baseline", "1119_hem_Baseline", "1146_hem_Baseline", "1118_hem_Baseline",
			"1146_hem_Baseline", "1053_hem_Baseline", "1093_hem_Baseline"
		],
