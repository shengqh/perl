...
my $def = {
  ...
  identicals => {
    "RPI40" => [ "/gpfs21/scratch/cqs/shengq1/vickers/20150401_parclip_2797_rat_mouse_human/rn5/identical/result/RPI40_clipped_identical.fastq.gz", ],
    "RPI41" => [ "/gpfs21/scratch/cqs/shengq1/vickers/20150401_parclip_2797_rat_mouse_human/rn5/identical/result/RPI41_clipped_identical.fastq.gz", ],
    "RPI42" => [ "/gpfs21/scratch/cqs/shengq1/vickers/20150401_parclip_2797_rat_mouse_human/rn5/identical/result/RPI42_clipped_identical.fastq.gz", ],
...
my $config = {
  ...
  'sequencetask' => {
    ...
    'source'    => { 'step1' => [ 'gsnap_smallRNA_t2c', 'unmappedReads', 'unmappedReads_bowtie1_genome_1mm', 'unmappedReads_bowtie1_genome_1mm_3utr_count', 'unmappedReads_bowtie1_genome_1mm_3utr_count_target' ] },
    'cluster'   => 'slurm',
    'sh_direct' => 0,
    'perform'   => 1,
