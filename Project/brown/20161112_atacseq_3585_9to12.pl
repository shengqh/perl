...
my $target_dir = create_directory_or_die("/scratch/cqs/shengq1/brown/20161112_atacseq_3585_9to12");
...
my $config = {
  general    => { task_name => "3585_9to12" },
  files      => {
    "3585-JDB-09_Control_6" => [ "/gpfs21/scratch/cqs/shengq1/brown/data/3585/3585-JDB-9_S63_R1_001.fastq.gz", "/gpfs21/scratch/cqs/shengq1/brown/data/3585/3585-JDB-9_S63_R2_001.fastq.gz" ],
    "3585-JDB-10_Control_4" => [ "/gpfs21/scratch/cqs/shengq1/brown/data/3585/3585-JDB-10_S64_R1_001.fastq.gz", "/gpfs21/scratch/cqs/shengq1/brown/data/3585/3585-JDB-10_S64_R2_001.fastq.gz" ],
    "3585-JDB-11_LMNA_G4" => [ "/gpfs21/scratch/cqs/shengq1/brown/data/3585/3585-JDB-11_S65_R1_001.fastq.gz", "/gpfs21/scratch/cqs/shengq1/brown/data/3585/3585-JDB-11_S65_R2_001.fastq.gz" ],
    "3585-JDB-12_LMNA_G5" => [ "/gpfs21/scratch/cqs/shengq1/brown/data/3585/3585-JDB-12_S66_R1_001.fastq.gz", "/gpfs21/scratch/cqs/shengq1/brown/data/3585/3585-JDB-12_S66_R2_001.fastq.gz" ],
  },
  treatments => {
    "3585-JDB-09_Control_6" => "3585-JDB-09_Control_6",
    "3585-JDB-10_Control_4" => "3585-JDB-10_Control_4",
    "3585-JDB-11_LMNA_G4" => "3585-JDB-11_LMNA_G4",
    "3585-JDB-12_LMNA_G5" => "3585-JDB-12_LMNA_G5",
  },
  fastqc_raw => {
    class      => "QC::FastQC",
    perform    => 1,
  ...
  sequencetask => {
    ...
    option     => "",
    source     => {
      T1 => [ "fastqc_raw",         "cutadapt",               "fastqc_trimmed",                 "fastqlen", "bwa", "bwa_cleanbam", "bwa_bam2bed", "bwa_macs2callpeak", "bwa_macs2callpeak_bradner_rose", "bwa_macs2callpeak_bradner_rose_coltron" ],
