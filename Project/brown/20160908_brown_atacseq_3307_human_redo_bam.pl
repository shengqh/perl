...
my $config = {
  ...
  sequencetask => {
    ...
    option     => "",
    source     => {
      T1 => [ "fastqc_raw", "cutadapt", "fastqc_trimmed", "fastqlen", "bwa", "bwa_cleanbam", "bwa_macs1callpeak" ],
      T2 => [ "fastqc_raw_summary", "fastqc_trimmed_summary", "bwa_macs1callpeak_bradner_rose", "bwa_macs1callpeak_bradner_rose_coltron" ],
