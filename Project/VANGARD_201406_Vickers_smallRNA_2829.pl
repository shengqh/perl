...
foreach my $def (@defs) {
  ...
  my $config     = {
    ...
    files   => {
      "2829-KCV-1A" => [ "/scratch/cqs/shengq1/vangard/VANGARD_Vickers/201405_smallRNA_2829/raw/2829-KCV-1A_ATCACG_L008_R1_001.fastq.gz" ],
      "2829-KCV-1B" => [ "/scratch/cqs/shengq1/vangard/VANGARD_Vickers/201405_smallRNA_2829/raw/2829-KCV-1B_CGATGT_L008_R1_001.fastq.gz" ],
      "2829-KCV-1C" => [ "/scratch/cqs/shengq1/vangard/VANGARD_Vickers/201405_smallRNA_2829/raw/2829-KCV-1C_TTAGGC_L008_R1_001.fastq.gz" ],
      "2829-KCV-1D" => [ "/scratch/cqs/shengq1/vangard/VANGARD_Vickers/201405_smallRNA_2829/raw/2829-KCV-1D_TGACCA_L008_R1_001.fastq.gz" ],
      "2829-KCV-1E" => [ "/scratch/cqs/shengq1/vangard/VANGARD_Vickers/201405_smallRNA_2829/raw/2829-KCV-1E_ACAGTG_L008_R1_001.fastq.gz" ],
      "2829-KCV-1F" => [ "/scratch/cqs/shengq1/vangard/VANGARD_Vickers/201405_smallRNA_2829/raw/2829-KCV-1F_GCCAAT_L008_R1_001.fastq.gz" ],
      "2829-KCV-1G" => [ "/scratch/cqs/shengq1/vangard/VANGARD_Vickers/201405_smallRNA_2829/raw/2829-KCV-1G_CAGATC_L008_R1_001.fastq.gz" ],
      "2829-KCV-1H" => [ "/scratch/cqs/shengq1/vangard/VANGARD_Vickers/201405_smallRNA_2829/raw/2829-KCV-1H_ACTTGA_L008_R1_001.fastq.gz" ],
      "2829-KCV-1I" => [ "/scratch/cqs/shengq1/vangard/VANGARD_Vickers/201405_smallRNA_2829/raw/2829-KCV-1I_GATCAG_L008_R1_001.fastq.gz" ],
      "2829-KCV-1J" => [ "/scratch/cqs/shengq1/vangard/VANGARD_Vickers/201405_smallRNA_2829/raw/2829-KCV-1J_TAGCTT_L008_R1_001.fastq.gz" ],
    },
    trimmer => {
    ...
    less50_miRNA_1mm_table => {
      class      => "CQSMirnaTable",
      perform    => 1,
      target_dir => "${target_dir}/less50_topN_bowtie1_genome_cutadapt_1mm_count_miRNA_table",
      option     => "",
    ...
    less50_miRNA_1mm_count_overlap => {
      class           => "CQSMappedCount",
      perform         => 1,
      target_dir      => "${target_dir}/less50_topN_bowtie1_genome_cutadapt_1mm_count_miRNA_overlap",
      option          => $mirna_overlap_count_option,
      source_ref      => "less50_bowtie1_genome_cutadapt_topN_1mm",
      fastq_files_ref => [ "less50_identical", ".fastq.gz\$" ],
      seqcount_ref    => [ "less50_identical", ".dupcount\$" ],
    ...
    less50_miRNA_1mm_overlap_position => {
      class      => "CQSMappedPosition",
      perform    => 1,
      target_dir => "${target_dir}/less50_topN_bowtie1_genome_cutadapt_1mm_count_miRNA_overlap_position",
      option     => "-o " . $task_name . "_miRNA.position",
    ...
    less50_tRNA_1mm_table => {
      class      => "CQSMappedTable",
      perform    => 1,
      target_dir => "${target_dir}/less50_topN_bowtie1_genome_cutadapt_1mm_count_tRNA_table",
      option     => "",
    ...
    less50_tRNA_1mm_position => {
      class      => "CQSMappedPosition",
      perform    => 1,
      target_dir => "${target_dir}/less50_topN_bowtie1_genome_cutadapt_1mm_count_tRNA_position",
      option     => "-o " . $task_name . "_tRNA.position",
    ...
    less50_smallRNA_1mm_count => {
      class           => "CQSMappedCount",
      perform         => 1,
      target_dir      => "${target_dir}/less50_topN_bowtie1_genome_cutadapt_1mm_count_smallRNA",
      option          => $trnacount_option,
      source_ref      => "less50_bowtie1_genome_cutadapt_topN_1mm",
      fastq_files_ref => [ "less50_identical", ".fastq.gz\$" ],
      seqcount_ref    => [ "less50_identical", ".dupcount\$" ],
    ...
    less50_smallRNA_1mm_table => {
      class      => "CQSMappedTable",
      perform    => 1,
      target_dir => "${target_dir}/less50_topN_bowtie1_genome_cutadapt_1mm_count_smallRNA_table",
      option     => "",
    ...
    less50_smallRNA_1mm_category => {
      class           => "CQSSmallRNACategory",
      perform         => 1,
      target_dir      => "${target_dir}/less50_topN_bowtie1_genome_cutadapt_1mm_count_smallRNA_category",
      option          => "",
