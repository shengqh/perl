...
my $def = {
  ...
  target_dir          => create_directory_or_die( $root . "human/" ),
  files               => {
    "3018-KCV-1-1" => ["/gpfs20/data/cqs/guom1/3018_rawdata/3018-KCV-1-1_ATCACG_L007_R1_001.fastq.gz"],
    "3018-KCV-1-2" => ["/gpfs20/data/cqs/guom1/3018_rawdata/3018-KCV-1-2_CGATGT_L007_R1_001.fastq.gz"],
  },
};
