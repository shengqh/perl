...
my $root     = create_directory_or_die("/scratch/cqs/shengq1/vangard/VANGARD_Vickers/201409_smallRNA_3018/");
...
my $def = {
  ...
  target_dir          => create_directory_or_die( $root . "mouse/" ),
  files               => {
    "3018-KCV-1-3" => ["/gpfs20/data/cqs/guom1/3018_rawdata/3018-KCV-1-3_TTAGGC_L007_R1_001.fastq.gz"],
    "3018-KCV-1-4" => ["/gpfs20/data/cqs/guom1/3018_rawdata/3018-KCV-1-4_TGACCA_L007_R1_001.fastq.gz"],
    "3018-KCV-1-5" => ["/gpfs20/data/cqs/guom1/3018_rawdata/3018-KCV-1-5_ACAGTG_L007_R1_001.fastq.gz"],
    "3018-KCV-1-6" => ["/gpfs20/data/cqs/guom1/3018_rawdata/3018-KCV-1-6_GCCAAT_L007_R1_001.fastq.gz"],
    "3018-KCV-1-7" => ["/gpfs20/data/cqs/guom1/3018_rawdata/3018-KCV-1-7_CAGATC_L007_R1_001.fastq.gz"],
    "3018-KCV-1-8" => ["/gpfs20/data/cqs/guom1/3018_rawdata/3018-KCV-1-8_ACTTGA_L007_R1_001.fastq.gz"],
  },
};
  ...
  sequencetask => {
    ...
    source     => {
      individual => [
        ...
        "bowtie1_genome_cutadapt_topN_genome_pmnames", "bowtie1_genome_cutadapt_topN_miRbase_pm",
