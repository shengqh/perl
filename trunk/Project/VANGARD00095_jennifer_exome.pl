...
my $config = {
  ...
  muTect => {
    ...
    annovar_param => "-buildver hg19 -protocol refGene,phastConsElements46way,genomicSuperDups,esp6500si_all,1000g2012apr_all,snp137,ljb2_all -operation g,r,r,f,f,f,f --remove",
