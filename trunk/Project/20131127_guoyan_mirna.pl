...
my $human = {
  ...
  groups              => {
    groups => {
      "2163-CRF" => [ "2163-CRF-01", "2163-CRF-10", "2163-CRF-11", "2163-CRF-12", "2163-CRF-02", "2163-CRF-03", "2163-CRF-04", "2163-CRF-05", "2163-CRF-06", "2163-CRF-07", "2163-CRF-08", "2163-CRF-09" ]
      ,
      "2245-CRF" =>
      ...
      "2403-CRF" => ["2403-CRF-01", "2403-CRF-10", "2403-CRF-11", "2403-CRF-12", "2403-CRF-13", "2403-CRF-14", "2403-CRF-15", "2403-CRF-18", "2403-CRF-19", "2403-CRF-02", "2403-CRF-20", "2403-CRF-21", "2403-CRF-22", "2403-CRF-23", "2403-CRF-24", "2403-CRF-26", "2403-CRF-28", "2403-CRF-03", "2403-CRF-04", "2403-CRF-05", "2403-CRF-06", "2403-CRF-07", "2403-CRF-08", "2403-CRF-09"],
    },
  }
};
...
foreach my $def (@defs) {
  ...
  my $config         = {
    ...
    miRNA_1mm_table => {
      class      => "CQSMirnaTable",
      perform    => 1,
      target_dir => "${cur_target_dir}/summary_1mm",
      option     => "",
    ...
    miRNA_1mm_overlap_table => {
      ...
      perform    => 1,
      target_dir => "${cur_target_dir}/summary_1mm_overlap",
      option     => "",
    ...
    tRNA_1mm_table => {
      class      => "CQSMappedTable",
      perform    => 1,
      target_dir => "${cur_target_dir}/summary",
      option     => "",
